		...
		get-windowsfeature MSMQ-Server,Web-Static-Content,Web-Default-Doc,Web-Dir-Browsing,Web-Http-Errors,Web-Asp-Net,Web-Net-Ext,Web-ISAPI-Ext,Web-ISAPI-Filter,Web-Http-Logging,Web-Request-Monitor,Web-Filtering,Web-Stat-Compression,Web-Dyn-Compression,Web-Mgmt-Console,Web-Scripting-Tools,Web-Mgmt-Service,NET-HTTP-Activation,NET-Non-HTTP-Activ,RSAT-AD-PowerShell,SNMP-Service,SNMP-WMI-Provider,Telnet-Client,WAS-Process-Model,WAS-NET-Environment,WAS-Config-APIs,Web-Http-Redirect,Web-Basic-Auth,Web-Windows-Auth,Web-Net-Ext45,Web-Asp-Net45,Web-CGI,Web-Includes,Web-WMI,Web-Lgcy-Scripting,Web-Lgcy-Mgmt-Console,Web-Metabase,Web-Mgmt-Compat,Web-WHC,Windows-Identity-Foundation,NET-Framework-Features,NET-Framework-Core
        ...
        add-windowsfeature MSMQ-Server,Web-Static-Content,Web-Default-Doc,Web-Dir-Browsing,Web-Http-Errors,Web-Asp-Net,Web-Net-Ext,Web-ISAPI-Ext,Web-ISAPI-Filter,Web-Http-Logging,Web-Request-Monitor,Web-Filtering,Web-Stat-Compression,Web-Dyn-Compression,Web-Mgmt-Console,Web-Scripting-Tools,Web-Mgmt-Service,NET-HTTP-Activation,NET-Non-HTTP-Activ,RSAT-AD-PowerShell,SNMP-Service,SNMP-WMI-Provider,Telnet-Client,WAS-Process-Model,WAS-NET-Environment,WAS-Config-APIs,Web-Http-Redirect,Web-Basic-Auth,Web-Windows-Auth,Web-Net-Ext45,Web-Asp-Net45,Web-CGI,Web-Includes,Web-WMI,Web-Lgcy-Scripting,Web-Lgcy-Mgmt-Console,Web-Metabase,Web-Mgmt-Compat,Web-WHC,Windows-Identity-Foundation,NET-Framework-Features,NET-Framework-Core
